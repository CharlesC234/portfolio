...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Charles Cahill</title>
            ...
            <meta name="keywords" content="500, internal server error, Charles Cahill, Portfolio,broken link ,missing page,link not found" />
