...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Charles Cahill</title>
            <meta name="description" content="Explore articles authored by Charles Cahill, a Full Stack Engineer and Developer." />
